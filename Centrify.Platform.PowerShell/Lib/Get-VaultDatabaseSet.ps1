...
<#
.SYNOPSIS
This Cmdlet returns a Collection of VaultDatabase objects.

.DESCRIPTION
This Cmdlet returns a Set of VaultDatabase.
...
.EXAMPLE
C:\PS> Get-VaultDatabaseSet
Returns all existing Sets of VaultDatabase.

.EXAMPLE
C:\PS> Get-VaultDatabaseSet -Name "Production databases"
Returns the Set of PASAccount named 'Production databases'.
#>
function global:Get-VaultDatabaseSet
{
	param
	(
