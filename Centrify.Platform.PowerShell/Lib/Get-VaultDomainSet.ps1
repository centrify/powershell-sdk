...
<#
.SYNOPSIS
This Cmdlet returns a Collection of VaultDomain objects.

.DESCRIPTION
This Cmdlet returns a Set of VaultDomains.

.PARAMETER Name
Mandatory Name of the Domain's Set to get
...
.EXAMPLE
C:\PS> Get-VaultDomainSet
Returns all existing Sets of VaultDomain.

.EXAMPLE
C:\PS> Get-VaultDomainSet -Name "West Coast"
Returns the Set of VaultDomain named 'West Coast'.
#>
function global:Get-VaultDomainSet
{
	param
	(
