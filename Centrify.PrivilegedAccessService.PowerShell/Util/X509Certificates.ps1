...
function Centrify.PrivilegedAccessService.PowerShell.X509Certificates.GetCertificateFromBase64String
{
    param(
...
function Centrify.PrivilegedAccessService.PowerShell.X509Certificates.AddCertificateToStore
{
    param
	(
...
function Centrify.PrivilegedAccessService.PowerShell.X509Certificates.GetCertificateFromStore
{
    param(
