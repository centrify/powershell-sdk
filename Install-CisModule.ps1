###############################################################################################################
# Install - Centrify.IdentityServices.PowerShell Module Installer
#
...
function Install-Module
{
    ...
    try
    {
        ...
        $Source = ("{0}\Centrify.IdentityServices.PowerShell" -f (Split-Path -Parent $PSCommandPath))
...
function Get-PsModulePath
{
    ...
    # Return Path
    return ("{0}Centrify.IdentityServices.PowerShell" -f $PSModulePath)
}
...
Write-Host
Write-Host "#########################################################"
Write-Host "# Centrify.IdentityServices.PowerShell Module Installer #"
Write-Host "#########################################################"
Write-Host

$InstallationPath = Get-PsModulePath
Write-Host ("Centrify Identity Services Module will be using Installation path:`n`t'{0}'" -f $InstallationPath)

if (Test-Path -Path $InstallationPath)
{
	# Build Menu
	$Title = "The Centrify Identity Services Module is already installed."
