# README
This is a PowerShell Module to manage objects into the Centrify Identity Services. This unofficial Module built on scripts is providing Cmdlets for Centrify Privilege Access Services.
...
# CONTACT
fabrice.viguier AT centrify.com
 
# INSTALL
	Run the Install-CisModule.ps1 script with Local Admin privilege. Script will install this PowerShell Module under C:\Program Files\Centrify\PowerShell
...
- First release of a set of Cmdlets for CIS built on Nick Gamb's PS samples to use Centrify RestAPI for the Cloud. The Cmdlets available are the ones below:		
	
# COPYING / LICENSE
	In order to use this PowerShell Module/Scripts, you need to have a Centrify Identity Services Tenant (Cloud based or on-prem installation).
 
# BUGS
	**INTERNAL ONLY** - To report bugs, please use the Bitbucket Issue tracker available here https://bitbucket.org/centrifyps/centrifycloudpowershellmodule